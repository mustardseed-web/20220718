...
Route::put('/update/{postId}', [TodoController::class, 'search_update'])->name('search_update');
Route::delete('/delete/{postId}', [TodoController::class, 'search_delete'])->name('search_delete');
